...
echo -n > ../data/pot_barrier_RT_all.dat
...
while [ $K -le 350 ]; do
    ...
    cp input_files/pot_well_template.in input_files/pot_barrier_$K.in

    # Add results_file with k0-dependent file name
    echo results_file = ../data/pot_barrier_k0_$K.dat >> input_files/pot_barrier_$K.in
    echo wf_output_text = ../data/pot_barrier_wave_k0_$K.dat >> input_files/pot_barrier_$K.in
    ...
    time ./barrier input_files/pot_barrier_$K.in $K > output_files/pot_barrier_k0_$K.out

    # Add value of k0 to file single_barrier_RT_all.dat
    echo -n $K" " >> ../data/pot_barrier_RT_all.dat
    # Add last time point of output from user_observe
    tail -1 ../data/pot_barrier_RT_k0_$K.dat >> ../data/pot_barrier_RT_all.dat
